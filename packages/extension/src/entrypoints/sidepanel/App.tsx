...
import { Globe, History, Send, Settings, Square } from 'lucide-react'
...
export default function App() {
	...
	// Update currentLanguage when config changes
	useEffect(() => {
		...
		<div className="relative flex flex-col h-screen bg-background">
			...
			<header className="flex items-center justify-between border-b px-3 py-2">
				...
				<div className="flex items-center gap-1">
					...
					>
						...
						<span className="text-xs">{currentLanguage === 'en-US' ? 'EN' : '中文'}</span>
					</Button>
				</div>
			</header>
			...
			<main className="flex-1 overflow-hidden flex flex-col">
				...
				<div ref={historyRef} className="flex-1 overflow-y-auto p-3 space-y-2">
					{showEmptyState && <EmptyState language={currentLanguage} />}
